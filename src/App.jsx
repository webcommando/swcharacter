...
<Table
  ...
  <TableBody>
    ...
    <Skill name="Walking" die="d4" description="Test" />
    <Skill name="Sneaking" die="d6" description="Sneakily" />

    {theNotes.map((note) => (
        <Skill name={note.name} die="DD" description={note.description} />
...
function Skill({name, die, description}) {
